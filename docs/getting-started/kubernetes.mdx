...
## Installation
```console
helm install seerr oci://ghcr.io/snapetech/seerrng/seerr-chart
```
Helm values can be found in the Seerr repository under [charts/seerr-chart/README.md](https://github.com/snapetech/seerrng/tree/main/charts/seerr-chart).
...
```console
cosign verify ghcr.io/snapetech/seerrng/seerr-chart:[tag] --certificate-identity=https://github.com/snapetech/seerrng/.github/workflows/helm.yml@refs/heads/main --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
